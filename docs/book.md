...
<p>Use <strong>Review</strong> to enable reviews and add focused reviewers with their own instructions, backend, model, and reasoning settings. Edit reviewers in a dialog or ask the Help agent to manage them. Agent-requested reviews return feedback automatically; manual reviews keep the existing submit flow. See <a href="#review-review-agents">focused AI reviewers</a>.</p>
