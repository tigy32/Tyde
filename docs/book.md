...
<h2 id="review-review-agents">Configure focused AI reviewers</h2>
<p>Open <strong>Settings → Review</strong> on the host where your agents run. Use the master switch to enable or disable reviews, and <strong>Add reviewer</strong> for each focus area. Each reviewer has a name, description, instructions, backend, and backend-provided model and reasoning controls. Use its switch to disable it, <strong>Edit</strong> to open its configuration dialog, or <strong>Delete</strong> to remove it. You can also ask the Help agent to add, edit, or remove reviewers.</p>
...
<p>Use <strong>Review</strong> to enable reviews and add focused reviewers with their own instructions, backend, model, and reasoning settings. Edit reviewers in a dialog or ask the Help agent to manage them. Agents await requested reviews and read findings through tools; manual reviews keep the existing submit flow. See <a href="#review-review-agents">focused AI reviewers</a>.</p>
