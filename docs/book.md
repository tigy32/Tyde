...
<p><strong>Run review</strong> in the Git review controls launches all enabled reviewers against the same snapshot. Progress, failures, findings, and agent responses appear by reviewer and round. <strong>Stop review</strong> interrupts the active reviewers. A failed or cancelled reviewer is incomplete, not a clean review.</p>
