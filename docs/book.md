...
<figure class="mobile-capture"><a href="assets/mobile-chat.png"><img src="assets/mobile-chat.png" width="1179" height="2040" alt="Tyde mobile conversation with demo agent Mira, an existing response, and a follow-up draft asking about keyboard navigation" loading="lazy"></a><figcaption>The conversation view with demo data: agent and harness at the top, messages in the transcript, and a follow-up draft in the composer. Tap the image to enlarge it.</figcaption></figure>
