...
pub fn ChatView() -> impl IntoView {
    ...
    let voice_entry_state = state.clone();
            ...
            <div class="chat-header">
                {move || {
                    if rename_editing.get() {
                        ...
                        let voice_entry_state = voice_entry_state.clone();
                        ...
                        view! {
                            ...
                            <div class="chat-header-actions">
                                <Show when=move || {
                                    voice_entry_state.host_settings_by_host.with(|_| ());
                                    voice_entry_state.connection_statuses.with(|_| ());
                                    voice_entry_state.active_local_host_id.with(|_| ());
                                    voice_entry_state.active_agent.with(|_| ());
                                    !matches!(
                                        crate::voice::VoiceController::entry_availability_for_active_agent(
                                            &voice_entry_state,
                                        ),
                                        crate::voice::VoiceEntryAvailability::Hidden(_)
                                    )
                                }>
                                    {
                                        let voice_controller = voice_controller.clone();
                                                ...
                                                <div class="chat-voice-entry">
                                                    <button
                                                        ...
                                                        disabled=move || {
                                                            ...
                                                            voice_enabled_state.active_local_host_id.with(|_| ());
                                                    ...
                                                    {move || {
                                                        ...
                                                        voice_reason_state.active_local_host_id.with(|_| ());
