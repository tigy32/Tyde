    ...
    A: ToSocketAddrs,
{
    ...
    pub(crate) async fn event_loop(
        ...
        loop {
            ...
            // TURN reads feed the core, and core writes feed TURN. Drain both
            // directions before sleeping, including events produced by relay reads.
    ...
    async fn poll_writes(&mut self) -> Result<()> {
        ...
        // Core relay writes enqueue TURN packets. Drain them before the TURN
        // queue so a final packet never waits for an unrelated timer or wake.
